...
Md5.prototype = {
	...
	*/
	hex_md5: function hex_md5(s){ return this.binl2hex(this.core_md5(this.str2binl(s), s.length * this.chrsz));},
	b64_md5: function b64_md5(s){ return this.binl2b64(this.core_md5(this.str2binl(s), s.length * this.chrsz));},
	str_md5: function str_md5(s){ return this.binl2str(this.core_md5(this.str2binl(s), s.length * this.chrsz));},
	hex_hmac_md5: function hex_hmac_md5(key, data) { return this.binl2hex(this.core_hmac_md5(key, data)); },
	b64_hmac_md5: function b64_hmac_md5(key, data) { return this.binl2b64(this.core_hmac_md5(key, data)); },
	str_hmac_md5: function str_hmac_md5(key, data) { return this.binl2str(this.core_hmac_md5(key, data)); },
